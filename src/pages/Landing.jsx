  ...
  return (
    ...
    <Alert className="rounded-none font-white-100" color="amber" open={open} onClose={() => setOpen(false)}>
        <Typography variant="small">
            For collaborations or feedbacks, please reach out to <a className='underline ms-1 me-1' target='_blank' href="https://mail.google.com/mail/u/0/?fs=1&to=ashleshshenoy09@gmail.com&tf=cm"> ashleshshenoy09@gmail.com</a> Your feedback is invaluable to us; we'd love to hear from you!
        </Typography>
    </Alert>
    ...
    <section className="bg-white dark:bg-gray-900">
        <div className="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
            <div className="mr-auto place-self-center lg:col-span-7">
                ...
                <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Build marketing campaigns  on <a target="_blank" href="https://www.whatsapp.com" className="hover:underline"> whatsapp</a>. Integrate your <a target="_blank" href="https://www.shopify.com/" className="hover:underline">Shopify store</a> to build auomations. </p>
                <div className="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                    <a href="https://github.com/ashleshshenoy/watomateapp" target="_blank" className="inline-flex items-center justify-center w-full px-5 py-3 text-sm font-medium text-center text-gray-900 border border-gray-200 rounded-lg sm:w-auto hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                    ...
                    <a href="https://www.youtube.com/watch?v=fIN0sXFfOGw" target="_blank" className="inline-flex items-center justify-center w-full px-5 py-3 mb-2 mr-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:w-auto focus:outline-none hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
        ...
        <div className="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
            ...
            <div className="text-center">
                ...
                <ul className="flex justify-center mt-5 space-x-5">
                    ...
                    <li>
                        <a href="https://github.com/ashleshshenoy" target="_blank" className="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
                    ...
                    <li>
                        <a href="https://www.linkedin.com/in/ashlesh-shenoy/" target="_blank" className="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
